...
export const PRIVACY_SECTIONS: { h2: string; paragraphs: string[] }[] = [
  {
    ...
    paragraphs: [
      `${SITE_ORG_NAME} is an independent information and registration resource for Arbourview, a pre-construction community by Mattamy Homes in Georgetown, Ontario. This site is not the official website of Mattamy Homes and is not affiliated with or endorsed by the builder. The canonical host is ${SITE_URL}/.`,
    ],
  },
  {
    h2: "What is collected and why",
    paragraphs: [
      "When you submit the registration form, this site collects five fields: first name, last name, email address, telephone number, and whether you are a licensed real estate agent. Those fields are used to respond to the registration request and to provide Arbourview project updates when Mattamy Homes releases pricing, floor plans, or a VIP launch date.",
  ...
  },
  {
    ...
    paragraphs: [
      "Registration records are retained for as long as they are needed to administer the Arbourview registration list, and for a reasonable period afterward to demonstrate CASL consent if a question arises, unless a shorter period is required by law.",
  ...
  },
  {
    ...
    paragraphs: [
      "Electronic messages about Arbourview and similar pre-construction opportunities are sent only where the visitor has checked the consent box on the registration form. That checkbox is never pre-checked. Consent, the time of consent, and the page on which it was given are stored as a proof record. Every electronic message will include a working unsubscribe mechanism. You may also withdraw consent by submitting a request through the registration form.",
    ],
  },
  {
    h2: "Accessibility",
  ...
  },
  {
    ...
    paragraphs: [
      "Privacy, access, correction, and deletion requests must be submitted through the registration form on this site. There is no phone number, personal email address, or named individual published anywhere on arbourviewmattamy.com.",
    ],
  },
];
...
export const TERMS_SECTIONS: { h2: string; paragraphs: string[] }[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Project names, builder names, and any official photographs or renderings remain the property of their respective owners. Photographs on this site are neighbourhood-context imagery used to illustrate downtown Georgetown, Hungry Hollow trails, and a wider-lot street character. They are not official Mattamy Homes architectural renderings of Arbourview and should not be treated as a representation of finished homes, landscaping, or views.",
    ],
  },
  {
