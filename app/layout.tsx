...
const gsc = process.env.NEXT_PUBLIC_GSC_VERIFICATION; // replace with real Google Search Console verification token before launch
const bing = process.env.NEXT_PUBLIC_BING_VERIFICATION; // replace with real Bing Webmaster verification token before launch
